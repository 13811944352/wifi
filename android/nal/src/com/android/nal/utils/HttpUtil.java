...
public class HttpUtil {
	...
	public static String httpGetFile(final Context context, final String uri, final String path){
		String result = null;
		HttpURLConnection conn = null;
		try {
			log( context.getPackageName() + " : " + uri);
			URL url = new URL(uri);
	...
	//2014-9-25
	public static String httpPost(final Context context, final String uri, final String body, final String desc){
